                ...
                <div class="col-lg-12">
                    <div class="tabs-container">
                            <ul class="nav nav-tabs">
                                ...
                                <li class=""><a data-toggle="tab" href="ecommerce_product.html#tab-2"> Data</a></li>
                                <li class=""><a data-toggle="tab" href="ecommerce_product.html#tab-3"> Discount</a></li>
                                <li class=""><a data-toggle="tab" href="ecommerce_product.html#tab-4"> Images</a></li>
                            </ul>
